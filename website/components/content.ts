...
export const LINKS = {
  ...
  instagram: 'https://instagram.com/cheapmarket.az',
...
const az = {
  ...
  pricing: {
    ...
    freePrice: '0 ₼',
    freePer: '/ həmişə',
    freeItems: ['1 aktiv səbət + 1 yadda saxlanılan siyahı', 'Bütün səbət üçün qiymət müqayisəsi', 'Ən sərfəli market və ən yaxın filial', 'Xəritə, iş saatları və marşrut', 'Barkod skanı marketin içində', 'Gündə 1 dəfə şəkillə məhsul tanıma', 'Xal topla, dostunu dəvət et'],
...
const en: typeof az = {
  ...
  pricing: {
    ...
    freePrice: '0 ₼',
    freePer: '/ forever',
    freeItems: ['1 active basket + 1 saved list', 'Whole-basket price comparison', 'Cheapest store and nearest branch', 'Map, opening hours and directions', 'In-store barcode scan', 'Photo product recognition, once a day', 'Earn points, invite friends'],
    freeCta: 'Start free',
    plus: 'PLUS',
    plusPer: '/ month',
